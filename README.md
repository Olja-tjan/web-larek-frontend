...
#### Класс <span style="color:#993131">Data</span>
...
- `productsInBasket: IProduct[]` - массив товаров добавленных в корзину
- `productsCounter: number | null` - количество товаров в корзине
- `indexProducts: number[]` - массив индексов товара в корзине
...
- `updateProductsInBasket(): void` - обнавляет массив товаров добавленных в корзину и массив с их id
...
- `сountProducts(): number | null` - счётчик товаров в корзине
- `setIndexProducts(): number[]` - определяет массив с порядковыми номерами товаров в корзине
- `checkValidationBasket(): boolean` - проверяет наличие заказанных товаров в корзине
- `checkValidationPaymentForm(): boolean` - проверяет заполнены ли все поля формы с данными пользователя для оформления заказа
- `checkValidationContactsForm(): boolean` - проверяет заполнены ли все поля формы с контактными данными пользователя
...
- `productsBasket:changed` - изменение колличества товаров в корзине
...
- `order:cleaner` - событие, очищает данные пользователя в заказе
- `basket:cleaner` - событие, очищает данные заказа
