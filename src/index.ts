...
const shopData = new Data(events);
...
// cardsData.cards = testItems;

// console.log(cardsData.getCard("48e86fc0-ca99-4e13-b164-b98d65928b53"));

shopData.cards = testItems;

// Карточка
console.log(shopData.getCard("48e86fc0-ca99-4e13-b164-b98d65928b53"));

// Массив карточек
console.log(shopData.cards);

// Изменение статуса карточки
shopData.selectProduct("48e86fc0-ca99-4e13-b164-b98d65928b53");
shopData.selectProduct("90973ae5-285c-4b6f-a6d0-65d1d760b102");

console.log(shopData.updateProductsInBasket())
